...
export function Lamborghini(props) {
  const { scene, nodes, materials } = useGLTF('/models/cars/lambo.glb')
  ...
  useFrame(() => {
    nodes.yellow_WhiteCar_0.material = new THREE.MeshPhysicalMaterial({
      roughness: 0.3,
      metalness: 0.05,
      color: UserStore.colors.split(',')[0],
  ...
  return <a.primitive onClick={(e) => console.log(e.object.name)} object={scene} {...props} />
}
